...
export class SketchPageComponent implements OnInit {
  ...
  sendToVerify() {
    ...
    if (window.location.href.startsWith('http://localhost:4200'))
      window.location.href = 'https://discordapp.com/api/oauth2/authorize?client_id=528166288527327262&redirect_uri=http%3A%2F%2Fsketch-bot.arduano.io%2F&response_type=code&scope=identify&state=x' + state;
    else
      window.location.href = 'https://discordapp.com/api/oauth2/authorize?client_id=528166288527327262&redirect_uri=http%3A%2F%2Fsketch-bot.arduano.io%2F&response_type=code&scope=identify&state=' + state;
  }
